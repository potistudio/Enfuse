...
impl Deck {
    ...
    pub fn play(&mut self) {
        ...
        self.control_speed
            .store(f32_to_u32(self.user_speed), Ordering::Relaxed);
    ...
    pub fn set_speed(&mut self, speed: f32) {
        ...
        self.control_speed
            .store(f32_to_u32(speed), Ordering::Relaxed);
    }
    ...
    pub fn seek_to(&mut self, pos: Duration) {
        ...
        self.control_cursor
            .store(f64_to_u64(sample_pos), Ordering::Relaxed);
    }
